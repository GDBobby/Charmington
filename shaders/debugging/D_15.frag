...
layout (set = 1, binding = 4) uniform sampler2D amOccSampler;
...
float roughness = texture(roughSampler, fragTexCoord).r;
float metal = texture(metalSampler, fragTexCoord).r;
